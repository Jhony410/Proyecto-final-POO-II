    ...
    if connection:
        ...
        for filename in os.listdir(directory):
            if filename.endswith(".csv"):
                ciudad = os.path.splitext(filename)[0]  # Nombre de la ciudad según el nombre del archivo ('Puno', '.csv')
...
def get_weather_data(city, date):
    ...
    if connection:
        ...
        try:
            ...
            """, (city, date))
            result = cursor.fetchone() # ('Lima',2024,1,7,0,17.0,11.0,92.5,0,0)
            cursor.fetchall()  # Leer todos los resultados restantes, si los hay (hace que este listo para la siguiente operacion)
            return result
        except Error as e:
...
class Ventana(Frame):
    ...
    def create_widgets(self):
        ...
        self.create_info_frame('Dirección del Viento (°)', 2, 2, 'presion.png')
    ...
    def cargar_csv(self):
        directory = r'C:\Users\TM Technologies EIRL\OneDrive\Desktop\PYTHON\Proyecto con mySQL\ciudades'  # Ajusta esto a tu directorio correcto
